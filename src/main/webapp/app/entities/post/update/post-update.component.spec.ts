...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: 11853 };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: 13202 }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: 456 };
      const tags: ITag[] = [{ id: 12848 }];
      post.tags = tags;

      const tagCollection: ITag[] = [{ id: 26407 }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: 456 };
      const blog: IBlog = { id: 23373 };
      post.blog = blog;
      const tag: ITag = { id: 21724 };
      post.tags = [tag];
