...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: 8361 };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: 31880 }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: 456 };
      const tags: ITag[] = [{ id: 26899 }];
      post.tags = tags;

      const tagCollection: ITag[] = [{ id: 23501 }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: 456 };
      const blog: IBlog = { id: 2131 };
      post.blog = blog;
      const tag: ITag = { id: 1144 };
      post.tags = [tag];
