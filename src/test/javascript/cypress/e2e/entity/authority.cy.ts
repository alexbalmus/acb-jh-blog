...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '33bc4287-8c2e-45a7-91b8-ca17b5236239' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('6194a556-731f-467c-8872-af6e50926673');
      cy.get(`[data-cy="name"]`).should('have.value', '6194a556-731f-467c-8872-af6e50926673');
