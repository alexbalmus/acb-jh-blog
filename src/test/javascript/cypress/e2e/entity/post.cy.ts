...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'cloudy', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2024-03-22T05:45:15.192Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('inquisitively beneath opposition');
      cy.get(`[data-cy="title"]`).should('have.value', 'inquisitively beneath opposition');
      ...
      cy.get(`[data-cy="date"]`).type('2024-03-21T13:20');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-03-21T13:20');
