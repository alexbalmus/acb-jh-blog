...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'energetically', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2023-12-13T21:32:31.361Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('bat immediately');
      cy.get(`[data-cy="title"]`).should('have.value', 'bat immediately');
      ...
      cy.get(`[data-cy="date"]`).type('2023-12-13T11:59');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2023-12-13T11:59');
