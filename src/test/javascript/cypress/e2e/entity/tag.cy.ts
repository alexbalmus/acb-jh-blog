...
describe('Tag e2e test', () => {
  ...
  const tagSample = { name: 'while joyously outlandish' };
  ...
  describe('new Tag page', () => {
    ...
    it('should create an instance of Tag', () => {
      cy.get(`[data-cy="name"]`).type('fortunately accost finesse');
      cy.get(`[data-cy="name"]`).should('have.value', 'fortunately accost finesse');
